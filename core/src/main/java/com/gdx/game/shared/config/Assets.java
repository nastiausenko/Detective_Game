package com.gdx.game.shared.config;
...
public class Assets {
    ...
    public static final String DOSSIER_OFFICER = "menu/dossier/dossier_officer.png";
    public static final String DOSSIER_CASHIER = "menu/dossier/dossier_cashier.png";
    public static final String DOSSIER_STUDENT = "menu/dossier/dossier_student.png";
    public static final String DOSSIER_DOCTOR = "menu/dossier/dossier_doctor.png";
